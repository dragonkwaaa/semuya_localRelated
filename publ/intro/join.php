...
<div class="container">
	...
	<div class="contents">
        ...
        <div class="imgBannerGroup pgTopSort">
            <img class="bannerImg absoluteCSort" alt="" src="/publ/common/img/topSliderImg_5.png">
        </div>
        <!-- :: close : ksg_4 : [세무야] 로그인 페이지 상단의 단일 이미지 배너 파트. -->
        <!-- :: open : ksg_5 : [세무야] 회원가입 박스 파트. -->
        <div class="mainCon userRegSort">
		    <div class="section joinSort">
                ...
                <div class="regGroup joinSort">
                    <div class="tBoxGroup">
                        ...
                        <div class="tipBox redSort">영문자, 숫자만 입력가능. 최소 3자이상 입력해주세요.</div>
                    </div>
                    <div class="tBoxGroup">
