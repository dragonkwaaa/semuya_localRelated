			...
			<div class="section">
				<div class="sectionHeadline">
					<div class="titleBox headLineSort">
						...
						<div class="titleText subMod">솔루션문의 목록</div>
					</div>
					<div class="btnGroup headLineSort rightSideMod">
						<a href="/manager/solution/solutionReg" class="btn">솔루션 등록</a>
					</div>
				</div>
								...
								<tr>
                                    ...
                                    <td>
										<div class="btnGroup listControlSort">
											<a href="/manager/solution/solutionReg" class="btn small darkGreyMod">상세</a>
