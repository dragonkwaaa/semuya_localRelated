			...
			<div class="section regSort">
				<div class="sectionHeadline">
					<div class="titleBox headLineSort">
						...
						<div class="titleText subMod">공지사항 등록</div>
					</div>
				</div>
				<div class="sectionCon">
					<div class="setField regSort">
						<table class="regTable">
							...
							<tr>
                                <th class="vertTopSort">내용</th>  
								<td>
                                    <textarea class="tarea singleLong1" placeholder="공지사항 내용을 입력해주세요."></textarea>
								</td>
                            </tr>
							</tbody>
						</table>
                        <div class="btnGroup bottomSort">
                            <a href="/manager/board/notice" class="btn pageCancelMod">취소</a>
					    	<a href="/manager/board/notice" class="btn pageConfirmMod">등록</a>
					    </div>
					</div>
				</div>
			</div>
